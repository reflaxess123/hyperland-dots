...
clear  # очистить экран перед показом

# ASCII баннер (можно заменить на figlet/slant или другой шрифт)
toilet -f pagga "ARCHCROCK" --gay

# Fastfetch с логотипом в kitty-графике
fastfetch --logo ~/.config/fastfetch/logo.png \
